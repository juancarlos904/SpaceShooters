...
pygame.display.set_caption("Space Shooter A Great Adventure")

#: Load the images is the first step
RED_ALIEN_SHIP = pygame.image.load("pixel_ship_red_small.png")
BLUE_ALIEN_SHIP = pygame.image.load("pixel_ship_blue_small.png")
GREEN_ALIEN_SHIP = pygame.image.load("pixel_ship_green_small.png")

#: Player Ship
YELLOW_ALIEN_SHIP = pygame.image.load("pixel_ship_yellow.png")
...
BACKGROUND = pygame.transform.scale(pygame.image.load("background-multi.png"), (WIDTH, HEIGHT))

#: I'm going to set up the main player
...
class Player(Ship):
    def __init__(self, x, y, health=100):
        ...
        self.ship_img = YELLOW_ALIEN_SHIP
...
class Enemy(Ship):
    COLOR_MAP = {
                "red": (RED_ALIEN_SHIP, RED_LASER),
                "green": (GREEN_ALIEN_SHIP, GREEN_LASER),
                "blue": (BLUE_ALIEN_SHIP, BLUE_LASER)
                }
...
def main():
    ...
    def redraw_window():
        ...
        # draw text
        lives_label = main_font.render(f"Lives Left: {lives}", 1, (25, 200, 25))
        level_label = main_font.render(f"Current Level: {level}", 1, (255, 20, 0))
        ...
        if lost:
            lost_label = lost_font.render("You Lost!! ALIENS WIN", 1, (0, 255, 255))
